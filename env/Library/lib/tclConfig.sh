...
# installed.
TCL_PREFIX='D:/mlproject/project1/env\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/mlproject/project1/env\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='D:/mlproject/project1/env\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/mlproject/project1/env\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/mlproject/project1/env\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='D:/mlproject/project1/env\Library\lib\tclstub86.lib'
